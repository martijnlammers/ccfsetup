...
var data = JSON.parse('{"someField":"someValue"}');
function send_https_req(options, json) {
    function promiseHandler(thenFunc, catchFunc) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, send_https_req(options, json)];
                case 1:
                    response = _a.sent();
